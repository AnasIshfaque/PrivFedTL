...
def medmnist_dataset(dataset_name, shape_img):
    ...
    image_datasets = {x:DataClass(split=x, transform=data_transform, download=True, size=128)
                for x in ['train','test']}
    print(image_datasets['train'][9][0])
    return image_datasets['train']
...
def main():
    ...
    if dataset == 'MNIST':
        ...
        channel = 3
        hidden = 588
        dst = medmnist_dataset('breastmnist', shape_img)
